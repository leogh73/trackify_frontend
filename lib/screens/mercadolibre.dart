...
class _MercadoLibreSiteState extends State<MercadoLibreSite> {
  ...
  void urlChangeHandler(BuildContext context, String url) {
    if (widget.action == "login" &&
        url.startsWith("https://www.mercadolibre.com.ar/?code")) {
  ...
  void initState() {
    ...
    if (widget.action == "login") {
      destinyUrl =
          "https://auth.mercadolibre.com.ar/authorization?response_type=code&client_id=${dotenv.env['ML_CLIENT_ID']}&redirect_uri=https://mercadolibre.com.ar";
    } else {
